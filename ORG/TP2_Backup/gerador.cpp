...
#define REPETICOES 90 /* (0 <= REPETICOES <= 100) Porcentagem que representa a quantidade de blocos de FOR repetidos dentro do NUM_INS.
-> O mesmo bloco (FOR) aparecera' "REPETICOES(%)" da quantidade total de blocos (FORs), nao necessariamente
em sequencia.
*/
#define TAM_MEM 500 //Tamanho da RAM
